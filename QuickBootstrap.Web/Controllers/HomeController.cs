...
namespace QuickBootstrap.Controllers
{
    ...
    {
        private readonly ILoginService _loginService = UnityHelper.Instance.Unity.Resolve<ILoginService>();
        ...
        public ActionResult Login(HomeLoginRequest model)
        {
            ...
            if (_loginService.Login(model.UserName, model.Password.ToMd5()))
            {
        ...
        public ActionResult LoginOut()
        {
            ...
            {
                //退出登录日志记录操作
                _loginService.Logout(Request.Cookies[UserAuthorizationAttribute.CookieUserName].Value);
